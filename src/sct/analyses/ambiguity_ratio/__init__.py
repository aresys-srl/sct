...
from sct.analyses.ambiguity_ratio.cli import pt_ambiguity_ratio_analysis
...
register_analysis(
    ...
    handler=AnalysisHandler(
        config=SCTTargetAmbiguityRatioConfig, cli_command=pt_ambiguity_ratio_analysis, testing=None
    ),
)
