...
"""SCT Testing - Elevation Notch Analysis Implementation"""
...
def run_notch_api(params: TestParams, output_dir: Path, config: SCTConfiguration | None, graphs: bool) -> TestOutput:
    ...
    nc_output = full_elevation_notch_analysis_implementation(
...
register_analysis(
    analysis_type=SCTAnalyses.ELEVATION_NOTCH,
