...
1. **Protocol Layer** (`sct.plugins.input_products_protocols`)
    ...
    - Contains **core abstractions** such as :py:class:`~sct.plugins.protocols.InputProductPluginProtocol` and :py:class:`~sct.plugins.protocols.AbsoluteLocalizationErrorCorrector`.
