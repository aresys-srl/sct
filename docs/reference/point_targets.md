...
for this application. The template of this .csv file can be downloaded from the GitHub [sct/resources](https://github.com/aresys-srl/sct/tree/main/sct/resources) folder and filled by the user with the information needed.
...
!!! danger "Validation"
    ...
    plate tectonics drift model implemented following the **ITRF2014-PMM**. [^2]
...
[^1]: Reference article with the implemented model can be found here [https://academic.oup.com/gji/article/209/3/1906/3095992](https://academic.oup.com/gji/article/209/3/1906/3095992).
[^2]: Plate names are those [defined in this paper](https://doi.org/10.1093/gji/ggx136).
